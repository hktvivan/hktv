...
| Location | Assets |
|----------|--------|
| **Source pack / staging** | `.agent_plan/`, scout reports, manifests, adaptation notes |
| **Target** | `.github/` (agents, instructions, prompts), optional editor config, `CONTRIBUTING.md` |
...
| Docs-first | `README.md`, `docs/`, `.github/` | Existing guidance folders, onboarding notes |
