...
| **Target project** | Approved exported artifacts such as `.github/agents/`, `.github/instructions/`, `.github/prompts/`, and optional editor config |
