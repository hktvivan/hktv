...
<projectguardian_implementation>
...
<project_context>
Read `workspace_context.instructions.md` and any matching local instructions before proceeding.
</project_context>
...
- **When invoked directly** (standalone): Use general best practices from `workspace_context.instructions.md` and any instructions matching the touched files.
...
### 2. Discovery
-   **MANDATORY READING**: `workspace_context.instructions.md` plus any instructions that match the touched files or documented workflow.
