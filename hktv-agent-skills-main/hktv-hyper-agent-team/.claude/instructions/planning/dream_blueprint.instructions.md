...
- Related Assets: Link to mockups/diagrams in `../assets/` folder (see `instructions/planning/dream_assets.instructions.md`)
...
- **Full specification**: See `instructions/planning/dream_assets.instructions.md` for detailed rules
