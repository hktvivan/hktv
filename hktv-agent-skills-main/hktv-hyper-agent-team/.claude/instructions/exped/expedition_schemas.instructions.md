...
adaptation_hints:
  suggested_agent_location: "target-approved agent directory"
  suggested_instruction_location: "target-approved instruction directory"
...
| Code | Check | Description |
|------|-------|-------------|
| `agents_exist` | Source agents present | `agents/` |
| `instructions_exist` | Source instructions present | `instructions/` |
...
adaptation:
  ...
  artifacts:
    agents:
      - source: "agents/xxx.agent.md"
        target: "<target-agent-dir>/xxx.agent.md"
    ...
    instructions:
      - source: ".claude/instructions/path/to/source.instructions.md"
        target: "<target-instruction-dir>/target.instructions.md"
        adaptation: transform | copy
    
    prompts:
      - source: ".claude/prompts/source.prompt.md"
        target: "<target-prompt-dir>/target.prompt.md"
        adaptation: copy
...
|---------------|----------------|----------------|
| Agents | `agents/*.agent.md` | `<target-agent-dir>/*.agent.md` |
| Instructions | `instructions/**/*.instructions.md` | `<target-instruction-dir>/*.instructions.md` |
| Prompts | `prompts/*.prompt.md` | `<target-prompt-dir>/*.prompt.md` |
...
|----------|------------------|-------------|
| `agents/hyper_architect.agent.md` | target workspace | `hyper_architect.agent.md` |
| `agents/hyper_san_checker.agent.md` | target workspace | `hyper_san_checker.agent.md` |
| `agents/hyper_orchestrator.agent.md` | target workspace | `hyper_orchestrator.agent.md` |
